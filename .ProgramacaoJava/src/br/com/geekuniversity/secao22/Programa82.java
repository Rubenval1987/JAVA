...
public class Programa82 {
	...
	public static void main(String[] args) {
		...
		System.out.println(hoje); //Formato internacional
		
		LocalDate ano_novo = LocalDate.of(2021, Month.JANUARY, 1);
		System.out.println(ano_novo); //Formato internacional
		...
		System.out.println(agora); //Formato internacional
		
		DateTimeFormatter formatador_horas = DateTimeFormatter.ofPattern("dd/MM/yyy HH:mm:ss"); //(HH-maiúsculo)Formato 24h
		System.out.println(agora.format(formatador_horas));
		
		LocalTime intervalo = LocalTime.of(13, 20);
